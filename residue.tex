...
\end{center}
Residue theory is a powerful tool to kill some integrals.  I have a proof and a little analysis in here, but I left most of them as excercises for you to do on your own.  To properly develop the theory we need some other stuff first \ldots
...
\end{proof}
Note that for this to hold, $f$ has to be analytic, but not nessecarily at $z_0$
