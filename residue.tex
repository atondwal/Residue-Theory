...
\end{center}
Residue theory is a powerful tool to kill some integrals. Ideally, I'd prove everything I use, but we don't have the time for that on a Friday lecture, so I'll just do the less trivial ones as examples.  To properly develop the theory we need some other stuff first....
...
\end{exc}
Now that we can do integrals on contours in the complex plane, we can use them to evaulate real definite integrals. I'll do a problem on the board, and then lecture problems.
\end{document}